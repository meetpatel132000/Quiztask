...
const counterSlice = createSlice({
  ...
  reducers: {
    ...
    addingData(state, action: PayloadAction<Array<Object>>) {
      state.storedQuestion.push(action.payload)
    },
    storingData(state, action: PayloadAction<Object>) {
...
export const { incremented, questionsToAsked, scoreCounted, addingData, storingData, finalData } = counterSlice.actions;
